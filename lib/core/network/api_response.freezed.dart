...
abstract class $ApiErrorCopyWith<$Res> {
  ...
  @useResult
  $Res call({int status, String error, String? timestamp});
}
...
class _$ApiErrorImpl implements _ApiError {
  ...
  @override
  String toString() {
    return 'ApiError(status: $status, error: $error, timestamp: $timestamp)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, status, error, timestamp);
