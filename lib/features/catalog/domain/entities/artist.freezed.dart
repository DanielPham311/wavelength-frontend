...
class _$ArtistImpl implements _Artist {
  ...
  @override
  String toString() {
    return 'Artist(id: $id, userId: $userId, name: $name, bio: $bio, avatarUrl: $avatarUrl, verified: $verified)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, userId, name, bio, avatarUrl, verified);
